...
export const XpLevelCard = memo(({
  ...
  return (
    <div
      className={cn(
        "p-5 rounded-2xl glass-card relative overflow-hidden",
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <div 
                className={cn(
                  "absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-primary flex items-center justify-center text-xs font-bold text-primary-foreground shadow-lg",
                  !shouldReduce && "animate-scale-in"
                )}
              >
                {level}
              </div>
...
XpLevelCard.displayName = "XpLevelCard";
