        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <section>
            <p className="text-muted-foreground leading-relaxed">
              Der Schutz Ihrer personenbezogenen Daten ist uns ein wichtiges Anliegen. In dieser Datenschutzerklärung informieren wir Sie darüber, welche personenbezogenen Daten wir bei der Nutzung unserer Webapplikation FaceRank (nachfolgend "App") erheben, wie wir diese Daten verwenden und welche Rechte Ihnen zustehen.
            </p>
