-- Create function to request admin password reset for any user (owner only)
...
BEGIN
  ...
  INSERT INTO admin_password_reset_tokens (user_id, token, expires_at)
  VALUES (_target_user_id, _token, now() + interval '1 hour');
  
  -- Log the action
  INSERT INTO audit_logs (user_id, action, details)
  VALUES (_caller_id, 'admin_password_reset_requested_for_user', 
